...
FLIGHTMARE_PATH = os.path.join(f"{AS2_WS_PATH}", "src/aerostack2/thirdparty/flightmare/flightrender1/RPG_Flightmare.x86_64")
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('drone_id', default_value='drone_sim_javilino0'),
